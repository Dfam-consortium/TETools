...
download https://github.com/oushujun/LTR_retriever/archive/v2.8.7.tar.gz LTR_retriever-2.8.7.tar.gz
download https://mafft.cbrc.jp/alignment/software/mafft-7.453-without-extensions-src.tgz
